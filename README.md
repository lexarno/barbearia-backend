...
- O usuário deve receber um e-mail com informações de recuperação de senha;
...
- O link enivado por e-mail para resetar a senha, deve expirar em 2h;
...
- O usuário não pode agendar em um horário já marcado para o prestador;
- O usuário não pode agendar serviços pra ele mesmo;
